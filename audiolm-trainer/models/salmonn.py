...
class SALMONN(nn.Module):
    ...
    def get_llama_embed_tokens(self):
        """LoRA 적용 여부에 따라 LLaMA 임베딩 레이어 반환"""
        if self.lora:
            # peft wrapper 내부에 또 model이 중첩되어 있음
    ...
    def __init__(
        ...
        # Speech Q-Former 및 speech-to-LLM projection layer 설정
        if self.use_speech_Qformer:
            ...
            # Speech to LLaMA projection layer
